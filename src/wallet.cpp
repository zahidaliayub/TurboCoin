...
// turbocoin: total coins staked (non-spendable until maturity)
...
// TurboCoin: get current stake weight
...
// turbocoin: check 'spent' consistency between wallet and txindex
// turbocoin: fix wallet spent state according to txindex
...
// turbocoin: disable transaction (only for coinstake)
